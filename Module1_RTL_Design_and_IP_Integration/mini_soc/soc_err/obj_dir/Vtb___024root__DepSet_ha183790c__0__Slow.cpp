...
VL_ATTR_COLD void Vtb___024root___dump_triggers__act(Vtb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb.clk or negedge tb.rst)\n");
    }
...
VL_ATTR_COLD void Vtb___024root___dump_triggers__nba(Vtb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb.clk or negedge tb.rst)\n");
    }
...
VL_ATTR_COLD void Vtb___024root___ctor_var_reset(Vtb___024root* vlSelf) {
    ...
    vlSelf->tb__DOT__in1 = VL_RAND_RESET_I(4);
    vlSelf->tb__DOT__in2 = VL_RAND_RESET_I(4);
    vlSelf->tb__DOT__sel = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__tx_en = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__tx_done = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__tut__DOT__result = VL_RAND_RESET_I(4);
