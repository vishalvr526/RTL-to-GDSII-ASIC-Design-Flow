...
void Vsync_stage_tb___024root__trace_chg_sub_0(Vsync_stage_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelf->sync_stage_tb__DOT__clk));
    bufp->chgBit(oldp+1,(vlSelf->sync_stage_tb__DOT__async_in));
    bufp->chgBit(oldp+2,(vlSelf->sync_stage_tb__DOT__sync_out));
    bufp->chgBit(oldp+3,(vlSelf->sync_stage_tb__DOT__dut__DOT__sync_ff1));
}
