...
VL_ATTR_COLD void Vsync_stage_tb___024root__trace_init_sub__TOP__0(Vsync_stage_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+3,"sync_out", false,-1);
    tracep->pushNamePrefix("dut ");
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"async_in", false,-1);
    tracep->declBit(c+3,"sync_out", false,-1);
    tracep->declBit(c+4,"sync_ff1", false,-1);
...
VL_ATTR_COLD void Vsync_stage_tb___024root__trace_full_sub_0(Vsync_stage_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->sync_stage_tb__DOT__clk));
    bufp->fullBit(oldp+2,(vlSelf->sync_stage_tb__DOT__async_in));
    bufp->fullBit(oldp+3,(vlSelf->sync_stage_tb__DOT__sync_out));
    bufp->fullBit(oldp+4,(vlSelf->sync_stage_tb__DOT__dut__DOT__sync_ff1));
}
